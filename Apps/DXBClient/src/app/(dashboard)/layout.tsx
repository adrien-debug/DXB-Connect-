...
export default function DashboardLayout({
  ...
  return (
    <div className="flex min-h-screen relative bg-zinc-950">
      {/* Mobile header */}
      <header className="lg:hidden fixed top-0 left-0 right-0 z-40 bg-zinc-900/90 backdrop-blur-xl border-b border-zinc-800 px-4 py-3">
        <div className="flex items-center justify-between">
          <div className="flex items-center gap-3">
            ...
            <div>
              <h1 className="text-sm font-semibold text-white tracking-tight">DXB Connect</h1>
      ...
      {/* Desktop header */}
      <header className="hidden lg:flex fixed top-0 right-0 left-[280px] z-40 h-[72px] px-8 items-center justify-between bg-zinc-950/80 backdrop-blur-xl border-b border-zinc-800/60">
